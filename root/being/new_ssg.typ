...
#text-align(center)[#html-text(size: 175%)[*这听起来非常棒, 不是吗?*]]
...
#text-align(center)[#html-text(size: 175%)[*一刻也没有为#{Markdown}哀悼, 立刻来到战场的是: #Typst*]]
...
- #{LaTeX} 允许你改写几乎任何层级的规则和格式, 你拥有堪称强迫症一般的排版上的绝对主权, 而代价却是复杂的语法与漫长的编译
