...
= 自然的祛魅与机械世界观的兴起
近代科学革命的黎明，以一场对亚里士多德-经院哲学世界观的彻底颠覆为标志。勒内·笛卡尔是这场革命的先锋，他用其著名的实体二元论，彻底瓦解了质形论的统一体 。笛卡尔将实在界划分为两种根本不同的实体：   

思维实体（rescogitans，即心灵）和广延实体（resextensa，即物质） 。物质的本质被重新定义为纯粹的、可被数学量化的几何广延。它不再是拥有内在潜能的质料，而是一种被动的、无生命的、完全由外在法则支配的惰性存在 。这一革命性的定义，将亚里士多德式的“形式”（作为事物的内在本质或目的）从物质世界中彻底驱逐了出去。   
...
作为对笛卡尔二元论的批判性回应，巴鲁赫·斯宾诺莎提出了其激进的一元论学说——“上帝即自然”（DeussiveNatura） 。在他看来，宇宙间只存在一个实体，即上帝或自然，它拥有无限多的属性，其中思想和广延是我们能够认识的两个。这克服了笛卡尔的二元论，将心灵和物质视为同一根本实在的两个不同侧面。斯宾诺莎的世界是一个由内在的、决定论的因果律支配的统一体，它彻底拒斥了任何目的论和神圣干预，从而提供了一条通往“祛魅”的不同道路——不是通过将心灵与死寂的自然分离开来，而是通过将它们统一在一个自因的、必然的自然秩序之中 。   

这种对自然的“祛魅”，无论是以笛卡尔-牛顿的方式还是斯宾诺莎的方式，都构成了资本主义精神兴起的关键思想前提。通过将自然转变为一个死寂的、可量化的、纯粹工具性的客体，它就成了一种可以被无情地测量、分割、支配和剥削的“资源” 。那种将自然视为拥有自身目的的有机论世界观，是这种剥削模式的意识形态障碍。而新的机械“形式”（即数学化的自然法则）的确立，则为资本对“质料”（作为资源的自然）的全面统治提供了理论许可。   
